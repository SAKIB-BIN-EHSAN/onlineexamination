		...
		<div class="contentsection template clear">
			...
			<div class="belowsidebar clear">
				<div class="below clear">
					<h2>Notices</h2>
						<ul>
							<li><a href="brain.php">Brain of Varendra University Competition</a></li>
							<li><a href="brain_of_intelligence.php">Brain of Intelligence: Quiz Competition-2017</a></li>
							<li><a href="exam_routine.php">Final exam routine Summer-17 CSE Dept. - (27/07/2017)</a></li>
							<li><a href="class_routine.php">Cse class routine FALL-2017 - (14/09/2017)</a></li>
						</ul>
				</div>
			</div>
